...
@pytest.fixture
def remote_orchestrator(project: Project, request) -> "Iterator[r_orchestrator.RemoteOrchestrator]":
    ...
    remote_orchestrator = r_orchestrator.RemoteOrchestrator(host, user, env, project)
